...
# user=input("How much index you want to take in a list ?     ")
# user3=input("which index you want.......   ")
# empty=[]
# print "you have put "+str(user3)+" number\n"
...
# count=0
# if user > user3:
# 	print "your "+str(user3)+" index is",empty[user3]
# else:
# 	print "we have only "+str(user1)+"index in this list"
# 	print "so your answer is ",0
...
# for i in range(1,3):
# 	if i==1:
# 		user =input("how much index you want in first list "+str(a)+"      ")
# 		for j in range(user):
# 			empty=[]
# 			user1=input("how much index you want in this index...     ")
# 			for k in range(user1):
# 				user2=input()
# 				empty.append(user2)
# 			arry1.append(empty)
# 	if i==2:
